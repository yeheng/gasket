...
//! This requires:
//! 1. `GASKET_VAULT_PASSWORD` environment variable to be set
...
impl ConfigLoader {
    ...
    /// the vault password is available via `GASKET_VAULT_PASSWORD` environment variable.
    ...
    /// 1. Checking for `GASKET_VAULT_PASSWORD` environment variable
